const apiURL2 = 'https://api.openweathermap.org/data/2.5/weather?lat=41.223&lon=-111.9739&units=imperial&appid=762f823e91c9a4fe9f9e3d69f9ee6521';
...
function runWC() {
 ...
 // console.log(speed)
  ...
  var f = calcWindChill2(tempF, speed);
  document.getElementsByClassName("wChill2")[0].textContent = f;
}

function calcWindChill2(tempF, speed) {
  var t = tempF;
  var s = speed;
