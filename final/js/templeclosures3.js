const requestURL3 = 'https://bgibson9.github.io/final/json/temples.json';
...
fetch(requestURL3)
  ...
  .then(function (jsonObject) {
    ...
    if(temples[i].name == 'Provo City Center Temple' )
        {
      ...
      for (let j=0; j < temples[i].templeClosures.length; j++)
       ...
       //document.querySelector('span.temples').appendChild(p);
        document.querySelector('span.temples3').appendChild(span);
    }
  }
});