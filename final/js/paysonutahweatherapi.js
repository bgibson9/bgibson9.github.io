const apiURL4 = 'https://api.openweathermap.org/data/2.5/weather?lat=40.0444&lon=-111.7322&units=imperial&appid=762f823e91c9a4fe9f9e3d69f9ee6521';
...
fetch(apiURL4)
  ...
  //console.log(jsObject); //to test data pull
    ...
    document.getElementsByClassName('currently4')[0].textContent = jsObject.weather[0].description;
    document.getElementsByClassName('high-temp4')[0].textContent = jsObject.main.temp_max;
    document.getElementsByClassName('windSpeed4')[0].textContent = jsObject.wind.speed;
    document.getElementsByClassName('humidity4')[0].textContent = jsObject.main.humidity;
...
function runWC() {
  var tempF = parseFloat(document.getElementsByClassName("high-temp4")[0].textContent);
  var speed = parseFloat(document.getElementsByClassName("windSpeed4")[0].textContent);

 // console.log(tempF)
 // console.log(speed)

  var f = calcWindChill(tempF, speed);
  document.getElementsByClassName("wChill4")[0].textContent = f;
}
