   ...
   // console.table(jsonObject);  // temporary checking for valid response and data parsing
    ...
    if(towns[i].name == "Preston" ||  towns[i].name == "Soda Springs" || towns[i].name == "Fish Haven")
      ...
      //   birthplace.textContent = 'Place of Birth:' + ' ' + prophets[i].birthplace;
        ...
        // Here we are putting a tag inside another tog, we are putting the span inside of the card and above we have called the card a section. We are also pulling in the data from the JSON file into the HTML file.
